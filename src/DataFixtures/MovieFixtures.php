...
class MovieFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $rednotice->setPoster('rednoticeposter.jpg');
        ...
        $spidermanfarfromhome->setPoster('spidermanfarfromhomeposter.jpg');
        ...
        $joker->setPoster('jokerposter.jpg');
        ...
        $avengers->setPoster('avengersendgameposter.jpg');
